Xep Core version 0.13.2 is now available from:

  <https://xep.org/bin/xep-core-0.13.2/>
...
- #8908 `4a974b2` Update xep-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow xep-tx to create v2 transactions (xepdrak)
