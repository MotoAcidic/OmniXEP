Xep Core version 0.16.1 is now available from:

  <https://xepcore.org/bin/xep-core-0.16.1/>
...
- #12843 `df38b13` Test starting xepd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure xepd processes are cleaned up when tests end (sdaftuar)
