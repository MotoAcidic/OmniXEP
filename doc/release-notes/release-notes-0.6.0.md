Xep version 0.6.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Xep/bitcoin-0.6.0/test/
...
bitcoin: URIs onto the Xep-Qt window to start
payment.
