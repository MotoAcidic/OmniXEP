Xep version 0.5.4 is now available for download at:
http://sourceforge.net/projects/xep/files/Xep/xep-0.5.4/
...
http://gitorious.org/xep/xepd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Xep-Qt notifications under Growl 1.3.
Increase required age of Xep-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxXep properly when installing Xep-Qt over it. (Windows)
