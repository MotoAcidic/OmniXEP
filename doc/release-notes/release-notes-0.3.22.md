Download URL: https://sourceforge.net/projects/xep/files/Xep/xep-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 XEP fee schedule (users still pay 0.01 XEP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #xep00 - #xep99
