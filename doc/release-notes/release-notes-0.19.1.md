...
Xep Core version 0.19.1 is now available from:

  <https://xepcore.org/bin/xep-core-0.19.1/>
...
From Xep Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Xep Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Xep Core does not yet change appearance when
...
- #17488 fix "xepd already running" warnings on macOS (fanquake)
...
[Transifex](https://www.transifex.com/xep/xep/).
