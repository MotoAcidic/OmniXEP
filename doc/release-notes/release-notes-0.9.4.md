Xep Core version 0.9.4 is now available from:

  https://xep.org/bin/0.9.4/
...
this update is incompatible with the Xep system and could lead to consensus
forks.

Xep Core released binaries from https://xep.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~xep/+archive/ubuntu/xep
- A third-party or self-compiled Xep Core

upgrade to Xep Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
