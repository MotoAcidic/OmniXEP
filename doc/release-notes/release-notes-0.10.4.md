Xep Core version 0.10.4 is now available from:

  <https://xep.org/bin/xep-core-0.10.4/>
...
- #6953 `43c2789` Split xep-tx into its own package
- #6953 `dfe0d4d` Include xep-tx binary on Debian/Ubuntu
