Xep-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/xep/files/Xep/xep-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Xep
...
New/changed settings (command-line or xep.conf file)
--------------------------------------------------------
