...
This document provides guidelines for internationalization of the Xep Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xep_en.ts` remains unchanged.
