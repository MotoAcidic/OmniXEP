...
BOOST_AUTO_TEST_CASE(simple_send_restrictions)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(0,                OMNI_PROPERTY_XEP,  MSC_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(MSC_SEND_BLOCK,   OMNI_PROPERTY_XEP,  MSC_TYPE_SIMPLE_SEND, MP_TX_PKT_V0));
    BOOST_CHECK(!IsTransactionTypeAllowed(MAX_BLOCK,        OMNI_PROPERTY_XEP,  MSC_TYPE_SIMPLE_SEND, MAX_VERSION));
