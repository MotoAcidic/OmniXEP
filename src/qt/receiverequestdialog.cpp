...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatXepURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + XepUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatXepURI(info));
}
