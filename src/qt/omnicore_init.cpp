...
static bool getDisclaimerDialogResult()
{
    ...
    "xeps contained therein (for example for transaction fees or trading).\n\n"
    ...
    "EXPERIMENTAL. Your wallet data, xeps and Omni Layer tokens may be lost, "
    ...
    "PLEASE DO NOT use wallet(s) with significant amounts of xeps or Omni Layer "
