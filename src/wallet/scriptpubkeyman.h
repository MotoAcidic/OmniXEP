...
#ifndef XEP_WALLET_SCRIPTPUBKEYMAN_H
#define XEP_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Xep Core wallet was originally a collection of unrelated private
...
#endif // XEP_WALLET_SCRIPTPUBKEYMAN_H
