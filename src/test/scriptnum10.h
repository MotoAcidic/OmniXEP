...
#ifndef XEP_TEST_SCRIPTNUM10_H
#define XEP_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Xep Core 0.10.0, for cross-comparison.
 */
public:
