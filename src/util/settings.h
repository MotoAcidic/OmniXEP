// Copyright (c) 2019-2020 The Xep Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef XEP_UTIL_SETTINGS_H
#define XEP_UTIL_SETTINGS_H
...
//!       https://github.com/xep/xep/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored xep settings. This struct combines settings from the command line
