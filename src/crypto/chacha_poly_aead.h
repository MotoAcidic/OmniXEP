...
#ifndef XEP_CRYPTO_CHACHA_POLY_AEAD_H
#define XEP_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@xep.
 *
 ...
 *
 * The chacha20-poly1305@xep combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@xep cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@xep are relatively fast in
...
#endif // XEP_CRYPTO_CHACHA_POLY_AEAD_H
