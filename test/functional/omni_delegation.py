...
class OmniDelegation(XepTestFramework):
    ...
    def run_test(self):
        ...
        try:
            node.omni_sendgrant(delegate_address, sink_address, 3, "55")
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Issue new tokens from the delegate address without delegating access to it - expected to fail")

        # Try to name a delegate from an unrelated address - expected to fail
        try:
            node.omni_sendadddelegate(unrelated_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Name a delegate from an unrelated address - expected to fail")
        ...
        try:
            txid = node.omni_sendremovedelegate(unrelated_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Remove the delegate from an unrelated address - expected to fail")

        # Try to remove an unrelated address as issuer - expected to fail
        try:
            node.omni_sendremovedelegate(issuer_address, 3, unrelated_address)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Remove an unrelated address as issuer - expected to fail")

        # Try to remove an unrelated address as delegate - expected to fail
        try:
            node.omni_sendremovedelegate(delegate_address, 3, unrelated_address)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Remove an unrelated address as delegate - expected to fail")
        ...
        try:
            node.omni_sendremovedelegate(delegate_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Remove delegate as delegate - expected to fail")
        ...
        try:
            node.omni_sendremovedelegate(issuer_address, 3, delegate_address)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Remove delegate as issuer - expected to fail")
        ...
        try:
            node.omni_sendenablefreezing(delegate_address, 3)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Enable freezing as delegate - expected to fail")
        ...
        try:
            node.omni_senddisablefreezing(delegate_address, 3)
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Disable freezing as delegated - expected to fail")

        # Freeze tokens as issuer, while delegate is set - expected to fail
        try:
            node.omni_sendfreeze(issuer_address, sink_address, 3, "1000")
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Freeze tokens as issuer, while delegate is set - expected to fail")
        ...
        try:
            node.omni_sendfreeze(delegate_address, sink_address, 3, "1000")
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Freeze tokens as delegate, while delegate is set - expected to fail")
        ...
        try:
            node.omni_sendgrant(sink_address, sink_address, 3, "50")
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Grant tokens as holder - expected to fail")

        # Try to grant tokens as delegate, while no delegate is set - expected to fail
        try:
            node.omni_sendgrant(delegate_address, sink_address, 3, "77")
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Grant tokens as delegate, while no delegate is set - expected to fail")
        ...
        try:
            node.omni_sendgrant(issuer_address, sink_address, 3, "45")
        except:
            assert_equal(1, 1)
        else:
            raise AssertionError("Grant tokens as issuer, while delegate is set - expected to fail")
