...
This file is modified from python-xeplib.
"""
import hashlib
import struct
...
def bn2vch(v):
    """Convert number to xep-specific little endian format."""
...
OP_CHECKBLOCKATHEIGHTVERIFY = CScriptOp(0xb8)
...
OPCODE_NAMES.update({
    ...
    OP_NOP7: 'OP_NOP7',
    OP_NOP8: 'OP_NOP8',
    OP_CHECKBLOCKATHEIGHTVERIFY: 'OP_CHECKBLOCKATHEIGHTVERIFY',
    OP_NOP10: 'OP_NOP10',
