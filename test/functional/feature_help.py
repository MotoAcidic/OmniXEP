...
"""Verify that starting xep with -h works as expected."""

from test_framework.test_framework import XepTestFramework
from test_framework.util import assert_equal

class HelpTest(XepTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xep with -h for help text")
        ...
        self.log.info("Start xep with -version for version information")
        ...
        self.log.info("Start xepd with -fakearg to make sure it does not start")
