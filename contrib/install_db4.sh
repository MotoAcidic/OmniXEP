...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the xep repository."
  exit 1
fi
...
# See https://github.com/xep/xep/issues/16064
...
echo 'When compiling xepd, run `./configure` in the following way:'
echo
