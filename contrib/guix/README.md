# Bootstrappable Xep Core Builds

This directory contains the files necessary to perform bootstrappable Xep
Core builds.
...
- 24GB of free disk space on the partition that the Xep Core git repository
  resides in
...
For a Xep Core depends development environment, simply invoke
...
From the top of a clean Xep Core repository:
...
To use dongcarl's substitute server for Xep Core builds after having
