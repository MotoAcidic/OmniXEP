...
(define* (make-xep-cross-toolchain target
                                  #:key
...
desirable for building Xep Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-xep-cross-toolchain "i686-linux-gnu")
       (make-xep-cross-toolchain "x86_64-linux-gnu")
       (make-xep-cross-toolchain "aarch64-linux-gnu")
       (make-xep-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-xep-cross-toolchain "riscv64-linux-gnu"
