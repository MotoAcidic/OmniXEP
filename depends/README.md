...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_xep` executable (see https://github.com/xep/xep/pull/13543),
...
options will be passed to xep's configure. In this case, `--disable-wallet`.
