...
XEP_CONFIG_ALL="--disable-dependency-tracking --prefix=$DEPENDS_DIR/$HOST --bindir=$BASE_OUTDIR/bin --libdir=$BASE_OUTDIR/lib"
...
DOCKER_EXEC ../configure --cache-file=config.cache $XEP_CONFIG_ALL $XEP_CONFIG || ( (DOCKER_EXEC cat config.log) && false)
